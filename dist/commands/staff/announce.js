import { ApplicationIntegrationType, ChannelType, ContainerBuilder, InteractionContextType, italic, MediaGalleryBuilder, MediaGalleryItemBuilder, MessageFlags, PermissionFlagsBits, roleMention, SeparatorBuilder, SeparatorSpacingSize, SlashCommandBuilder, TextDisplayBuilder, FileBuilder, ButtonBuilder, ButtonStyle, } from "discord.js";
...
const announce = {
    ...
    execute: async (interaction) => {
        if (!interaction.guild?.members.me?.permissions.has([
            ...
            return sendErrorMessage(interaction, `-# Make sure I have permissions of mentioning roles, adding reactions and creating public threads!`, "danger");
        }
        ...
        const message1 = interaction.options.getString("message"), message2 = interaction.options.getString("message_2"), message3 = interaction.options.getString("message_3");
        ...
        container.addTextDisplayComponents(new TextDisplayBuilder().setContent(`-# ${getEmoji("bubble")} __@${interaction.user.username}__`));
        try {
            if (!channel ||
            ...
            try {
                ...
                await interaction.editReply({
                    content: italic(`# ${getEmoji("reactions.kaeru.thumbsup")}\n-# Done! Announcement sent to ${channel}!`),
                });
            }
            catch (sendError) {
