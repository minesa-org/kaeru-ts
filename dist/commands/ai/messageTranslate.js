...
`.trim();
            ...
            const sectionOriginal = new TextDisplayBuilder().setContent(`### ${emojis.globe} Original Message\n${formattedCleaned}`);
            const separator = new SeparatorBuilder()
                .setSpacing(SeparatorSpacingSize.Large)
                .setDivider(true);
            const sectionTranslated = new TextDisplayBuilder().setContent(`### ${emojis.swap} Translated\n${formattedTranslated}`);
