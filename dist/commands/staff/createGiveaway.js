...
const createGiveaway = {
    ...
    execute: async (interaction) => {
        ...
        if (!interaction.guild?.members.me?.permissions.has(PermissionFlagsBits.ManageEvents)) {
            return sendErrorMessage(interaction, `-# It seems like I can't create events.\n> ${getEmoji("reactions.user.thumbsup")} Got it! I will give you the permission to create, soon.`, "danger");
        }
